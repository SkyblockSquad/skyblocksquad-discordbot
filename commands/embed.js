module.exports = {
    ...
    execute(message, args, discord) {
        ...
        if (seperatedArgs.length < 1) return message.channel.send("**Error:** Invalid syntax! Please use **,embed [title] / {description} / {color} / {footer} / {timestamp}**\n*Title is required, the rest isn't*\n*To provide a color, use hexadecimal, for example: #ff00b9,*\n*or a color's name, for example RED*\n*Type 'none' for an empty footer*\n*To set a timestamp, provide anything*");
